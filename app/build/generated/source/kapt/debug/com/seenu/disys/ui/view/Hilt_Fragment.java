 ...
 */
public abstract class Hilt_Fragment extends androidx.fragment.app.Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Fragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Fragment_GeneratedInjector) this.generatedComponent()).injectFragment(UnsafeCasts.<Fragment>unsafeCast(this));
    }
  }
